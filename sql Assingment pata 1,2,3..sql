...
-- Set- (3) {Q2(b)}
delimiter //
create procedure cancel_status()
begin
insert into cancellations(ordernumber,customernumber,comments)
select ordernumber,customernumber,comments from orders
where status = 'cancelled'; 
end //
delimiter ;
  
drop procedure cancel_status;
call cancel_status();
